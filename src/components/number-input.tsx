...
export default function NumberInput({ onChange, value, id }: SimpleInputProps<number>) {
  return (
    <NumberField defaultValue={0} minValue={0} onChange={onChange} value={value} id={id}>
